        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100">
              Get in touch with our team for quotes, support, or any questions about our products
            </p>
          </div>
        </div>
      </section>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={formData.productInterest} onValueChange={(value) => handleInputChange("productInterest", value)}>
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="safety">Safety Products</SelectItem>
                        <SelectItem value="industrial">Industrial Ropes</SelectItem>
                        <SelectItem value="marine">Marine & Defense</SelectItem>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@azukaagri.com</p>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Farm Road<br />Agriculture City, AC 12345</p>
                    </div>
                  </div>
